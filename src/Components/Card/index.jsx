...
function Card({product, setProductDetail}) {
  const context = useContext(cartContext);//traerlo asi
  
  return (
    <div className='p-2 bg-white cursor-pointer w-56 h-60 rounded-lg border-2 mt-3' onClick={() => {setProductDetail(product.id)}}>
